...
var prefix = "n!"; //Bots Prefix
var statuses = [`P4ssy Lick`]; //Bot Status
var timers = 2;
const owners = ["1187059229555695747"]; //Bot  owners
...
I sent this : ${m.user.tag} ✅`);
    ...
    let embed = new Discord.MessageEmbed()
      ...
      .setDescription(
        `📬 : Messages are being sent... : \`${message.guild.members.cache.filter(
